...
if(super(e),e.type!==V.PROPERTY&&e.type!==V.ATTRIBUTE&&e.type!==V.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Jn(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===P||t===F)return t;let n=e.element,r=e.name;if(e.type===V.PROPERTY){if(t===n[r])return P}else if(e.type===V.BOOLEAN_ATTRIBUTE){if(!!t===n.hasAttribute(r))return P}else if(e.type===V.ATTRIBUTE&&n.getAttribute(r)===t+``)return P;return Xn(e),t}});function Qn(e){e.key!==`Escape`&&e.key!==`Tab`&&e.stopPropagation()}function $n(e,t){let n=e.trim(),r=n===``?NaN:Number(n);return n!==``&&!Number.isFinite(r)&&console.warn(`[wiener-linien-austria] walk-time "${e}" for ${t} is not a number — clearing`),Number.isFinite(r)&&r>0?Math.min(120,Math.round(r)):null}function er(e){return{"--wl-chip-color":e.fill,...e.text?{"--wl-chip-text":e.text}:{},...e.ink?{"--wl-chip-ink":e.ink}:{}}}function tr(e){return{background:e.fill,...e.ink?{"--wl-chip-ink":e.ink}:{}}}function nr(e,t){return e?.states?.[t]?.attributes}function rr(e,t,n){let r=/* @__PURE__ */ new Set;for(let i of e)i.direction===t&&(n&&i.line!==n||i.towards&&r.add(i.towards));return[...r].sort()}function ir(e){return $t(e.lines,e.picked).length>=2}function ar(e,t,n,r){let i=nr(e,t.entity),a=!i,o=i?.stop_name||t.entity,s=i?.line_colors??{},c=yt(e),l=e=>Ht(e,n.lineColorOverrides,s,c,`#5b6470`),u=new Set(t.lines??[]),d=en(i),f=u.size?[.../* @__PURE__ */ new Set([...d,...u])].sort():d,p=Yt(i),m=/* @__PURE__ */ new Map;for(let e of i?.departures??[])e.line&&e.type&&!m.has(e.line)&&m.set(e.line,e.type);let h=e=>({full:n.t(e===`H`?`dir_h`:`dir_r`),short:n.t(e===`H`?`dir_h_short`:`dir_r_short`)});return N`
    <section class="wl-section">
      ...
      <div class="wl-stop-body">
        ...
        ${!a&&f.length?ir({lines:f,picked:u})?lr(t,n,r,{attrs:i,triplets:p,picked:u,lines:f,colorOf:l,dirStrings:h}):cr(t,n,r,{attrs:i,triplets:p,picked:u,lines:f,dirStrings:h}):F}
  ...
  `}function sr(e,t,n,r){let{lines:i,picked:a,colorOf:o,typeByLine:s}=r,c=a.size?t.et(`lines_selected`).replace(`{n}`,String(a.size)).replace(`{total}`,String(i.length)):t.et(`lines_empty_means_all`);return N`
    <div class="wl-group">
      ...
      ${i.length?N`<div class="wl-chips">
            ${i.map(r=>{let i=a.size===0||a.has(r),c=mt(s.get(r));return N`<button
                type="button"
                class="wl-chip"
                style=${U(er(o(r)))}
  ...
  `}function cr(e,t,n,r){let{attrs:i,triplets:a,picked:o,lines:s,dirStrings:c}=r,l=$t(s,o),u=l.length===1?l[0]:void 0,d=e.direction??null,f=Qt(i,u),p=f.available.has(`H`),m=f.available.has(`R`),h=f.oneWay!==null,g=d===`H`||d===null&&f.oneWay===`H`,_=d===`R`||d===null&&f.oneWay===`R`,v=d===null&&!h,y=t=>{let r={};for(let[t,n]of Object.entries(e.line_directions??{}))l.includes(t)||(r[t]=n);n.setDirections(e.entity,{direction:t,lineDirections:r})},b=e=>f.unknown||f.available.has(e)?Zt(rr(a,e,u),c(e)):`${c(e).short}: ${t.et(`direction_not_served`)}`,x=f.oneWay!==null&&l.length===1?t.et(`direction_note_one_way`).replace(`{line}`,l[0]??``):``;return N`
    <div class="wl-group">
      ...
      <div class="wl-dirs">
        ...
        ${X({label:t.t(`dir_both`),active:v,disabled:h,title:h?t.et(`direction_unavailable`):t.t(`dir_both`),onClick:()=>y(null)})}
      </div>
