...
if(super(e),e.type!==V.PROPERTY&&e.type!==V.ATTRIBUTE&&e.type!==V.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Jn(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===P||t===F)return t;let n=e.element,r=e.name;if(e.type===V.PROPERTY){if(t===n[r])return P}else if(e.type===V.BOOLEAN_ATTRIBUTE){if(!!t===n.hasAttribute(r))return P}else if(e.type===V.ATTRIBUTE&&n.getAttribute(r)===t+``)return P;return Xn(e),t}});function Qn(e){e.key!==`Escape`&&e.key!==`Tab`&&e.stopPropagation()}function $n(e,t){let n=e.trim(),r=n===``?NaN:Number(n);return n!==``&&!Number.isFinite(r)&&console.warn(`[wiener-linien-austria] walk-time "${e}" for ${t} is not a number — clearing`),Number.isFinite(r)&&r>0?Math.min(120,Math.round(r)):null}function er(e){return{"--wl-chip-color":e.fill,...e.text?{"--wl-chip-text":e.text}:{},...e.ink?{"--wl-chip-ink":e.ink}:{}}}function tr(e){return{background:e.fill,...e.ink?{"--wl-chip-ink":e.ink}:{}}}function nr(e,t){return e?.states?.[t]?.attributes}function rr(e,t,n){let r=/* @__PURE__ */ new Set;for(let i of e)i.direction===t&&(n&&i.line!==n||i.towards&&r.add(i.towards));return[...r].sort()}function ir(e,t){return!e.singleLine&&$t(t.lines,t.picked).length>=2}function ar(e,t,n,r){let i=nr(e,t.entity),a=!i,o=i?.stop_name||t.entity,s=i?.line_colors??{},c=yt(e),l=e=>Ht(e,n.lineColorOverrides,s,c,`#5b6470`),u=new Set(t.lines??[]),d=en(i),f=u.size?[.../* @__PURE__ */ new Set([...d,...u])].sort():d,p=Yt(i),m=/* @__PURE__ */ new Map;for(let e of i?.departures??[])e.line&&e.type&&!m.has(e.line)&&m.set(e.line,e.type);let h=e=>({full:n.t(e===`H`?`dir_h`:`dir_r`),short:n.t(e===`H`?`dir_h_short`:`dir_r_short`)});return N`
  ...
  >
    ...
    <div class="wl-group">
      <span class="wl-label">${t.et(`direction_label`)}</span>
      ${u.map(e=>{let n=Qt(i,e),r=p(e),o=n.available.has(`H`),s=n.available.has(`R`),u=n.oneWay!==null,d=n.unknown,f=n=>t.et(`per_line_direction_aria`).replace(`{line}`,e).replace(`{direction}`,n===null?t.t(`dir_both`):Zt(rr(a,n,e),l(n)));return N`
          <div class="wl-override-row">
            <span class="wl-badge" style=${U(tr(c(e)))}
              >${e}</span
            >
            <div class="wl-dirs">
              ${X({label:l(`H`).short,active:r===`H`||r===null&&n.oneWay===`H`,disabled:!d&&!o,compact:!0,title:rr(a,`H`,e).join(` / `)||t.t(`dir_h`),ariaLabel:f(`H`),onClick:()=>m(e,`H`)})}
              ${X({label:l(`R`).short,active:r===`R`||r===null&&n.oneWay===`R`,disabled:!d&&!s,compact:!0,title:rr(a,`R`,e).join(` / `)||t.t(`dir_r`),ariaLabel:f(`R`),onClick:()=>m(e,`R`)})}
