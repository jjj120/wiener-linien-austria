...
* SPDX-License-Identifier: BSD-3-Clause
*/
if(super(e),e.type!==V.PROPERTY&&e.type!==V.ATTRIBUTE&&e.type!==V.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!Jn(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===P||t===F)return t;let n=e.element,r=e.name;if(e.type===V.PROPERTY){if(t===n[r])return P}else if(e.type===V.BOOLEAN_ATTRIBUTE){if(!!t===n.hasAttribute(r))return P}else if(e.type===V.ATTRIBUTE&&n.getAttribute(r)===t+``)return P;return Xn(e),t}});function Qn(e){e.key!==`Escape`&&e.key!==`Tab`&&e.stopPropagation()}function $n(e,t){let n=e.trim(),r=n===``?NaN:Number(n);return n!==``&&!Number.isFinite(r)&&console.warn(`[wiener-linien-austria] walk-time "${e}" for ${t} is not a number — clearing`),Number.isFinite(r)&&r>0?Math.min(120,Math.round(r)):null}function er(e){return{"--wl-chip-color":e.fill,...e.text?{"--wl-chip-text":e.text}:{},...e.ink?{"--wl-chip-ink":e.ink}:{}}}function tr(e){return{background:e.fill,...e.ink?{"--wl-chip-ink":e.ink}:{}}}function nr(e,t){return e?.states?.[t]?.attributes}function rr(e,t,n){let r=new Set;for(let i of e)i.direction===t&&(n&&i.line!==n||i.towards&&r.add(i.towards));return[...r].sort()}function ir(e,t){return!e.singleLine&&$t(t.lines,t.picked).length>=2}function ar(e,t,n,r){let i=nr(e,t.entity),a=!i,o=i?.stop_name||t.entity,s=i?.line_colors??{},c=yt(e),l=e=>Ht(e,n.lineColorOverrides,s,c,`#5b6470`),u=new Set(t.lines??[]),d=en(i),f=u.size?[...new Set([...d,...u])].sort():d,p=Yt(i),m=new Map;for(let e of i?.departures??[])e.line&&e.type&&!m.has(e.line)&&m.set(e.line,e.type);let h=e=>({full:n.t(e===`H`?`dir_h`:`dir_r`),short:n.t(e===`H`?`dir_h_short`:`dir_r_short`)});return N`
    <section class="wl-section">
      <header class="wl-section-header">
  ...
  `:F}function dr(e,t){let n=(n,r)=>{let i=e();i&&t(i.map(e=>e.entity===n?r({...e}):e))};return{toggleLine:(e,t)=>n(e,e=>{let n=new Set(e.lines??[]);return n.has(t)?n.delete(t):n.add(t),n.size?e.lines=[...n]:delete e.lines,e}),setDirections:(e,t)=>n(e,e=>(t.direction===null?delete e.direction:e.direction=t.direction,Object.keys(t.lineDirections).length?e.line_directions=t.lineDirections:delete e.line_directions,e)),setWalkTime:(e,t,r)=>n(e,e=>{let n={...e.walk_times??{}};return r===null?delete n[t]:n[t]=r,Object.keys(n).length?e.walk_times=n:delete e.walk_times,e}),remove:n=>{let r=e();r&&t(r.filter(e=>e.entity!==n))}}}function fr(e,t){let n=Array.isArray(t)?t.filter(e=>typeof e==`string`&&e.length>0):[],r=new Map(e.map(e=>[e.entity,e]));return n.map(e=>r.get(e)??{entity:e})}function pr(e,t,n){let r=t.et(n);return r===n?e?.localize?.(`ui.panel.lovelace.editor.card.generic.${n}`)||n:r}function mr(e,t,n){let r=n?.[t];if(r!==void 0)return r;let i=`${t}_helper`,a=e.et(i);return a===i?void 0:a}function Z(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}const hr={metro:`mode_metro`,sbahn:`mode_sbahn`,tram:`mode_tram`,badner:`mode_badner`,bus:`mode_bus`,night:`mode_night`};let gr=class extends z{constructor(...e){super(...e),this._tab=`stops`,this._onEntitiesChanged=e=>{e.stopPropagation(),this._config&&this._commit(Bt({...this._config,entities:fr(this._config.entities,e.detail.value.entities)}))},this._computeLabel=e=>pr(this.hass,this._i18n,e.name),this._computeHelper=e=>{let{et:t}=this._i18n,n=this._config;return mr(this._i18n,e.name,{...n?.show_accessibility?{}:{accessibility_only:t(`accessibility_only_requires`)},...n?.show_delay?{}:{show_delay_colors:t(`show_delay_colors_requires`)},...(n?.entities.length??0)>=2?{}:{layout:t(`layout_requires`)}})}}setConfig(e){this._config=Bt(e)}shouldUpdate(e){if(!this._config)return!1;if(e.has(`_config`)||e.has(`_tab`))return!0;let t=e.get(`hass`);return!t||!this.hass||this._config.entities.map(e=>e.entity).some(e=>t.states[e]!==this.hass.states[e])}get _i18n(){return Hn(`modern`,this.hass?.language)}_commit(e){this._config=e,pt(this,`config-changed`,{config:e})}_patch(e){this._config&&this._commit(Bt({...this._config,...e}))}get _stopCallbacks(){return dr(()=>this._config?.entities,e=>{this._config&&this._commit({...this._config,entities:e})})}render(){if(!this._config)return F;let{et:e}=this._i18n;return N`
    ...
    `}_toggleElevator(e){this._expandedElevator=sn(this._expandedElevator,e)}_onExpanderKeydown(e,t,n){t&&(e.key===`Enter`||e.key===` `)&&(e.preventDefault(),n())}_renderTrafficBanner(e){let t=new Set,n=[];for(let r of e)for(let e of this._attrs(r.entity).traffic_info??[])t.has(e.name)||(t.add(e.name),n.push(e));for(let e of this._debugTraffic)t.has(e.name)||(t.add(e.name),n.push(e));if(!n.length)return F;let r=qt(this.hass,this._config.entities.map(e=>e.entity));return N`
      <div class="alert-list">
