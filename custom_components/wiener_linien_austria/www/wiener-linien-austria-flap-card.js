...
* SPDX-License-Identifier: BSD-3-Clause
*/
const Ne=e=>(t,n)=>{n===void 0?customElements.define(e,t):n.addInitializer(()=>{customElements.define(e,t)})},Pe={attribute:!0,type:String,converter:x,reflect:!1,hasChanged:te},Fe=(e=Pe,t,n)=>{
/**
* @license
* Copyright 2017 Google LLC
* SPDX-License-Identifier: BSD-3-Clause
...
* SPDX-License-Identifier: BSD-3-Clause
*/
const z={ATTRIBUTE:1,CHILD:2,PROPERTY:3,BOOLEAN_ATTRIBUTE:4,EVENT:5,ELEMENT:6},B=e=>(...t)=>({_$litDirective$:e,values:t});var Le=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,t,n){this._$Ct=e,this._$AM=t,this._$Ci=n}_$AS(e,t){return this.update(e,t)}update(e,t){return this.render(...t)}};
/**
* @license
* Copyright 2018 Google LLC
* SPDX-License-Identifier: BSD-3-Clause
*/const V=B(class extends Le{constructor(e){if(super(e),e.type!==z.ATTRIBUTE||e.name!==`class`||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return` `+Object.keys(e).filter(t=>e[t]).join(` `)+` `}update(e,[t]){if(this.st===void 0){this.st=/* @__PURE__ */ new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(` `).split(/\s/).filter(e=>e!==``)));for(let e in t)t[e]&&!this.nt?.has(e)&&this.st.add(e);return this.render(t)}let n=e.element.classList;for(let e of this.st)e in t||(n.remove(e),this.st.delete(e));for(let e in t){let r=!!t[e];r===this.st.has(e)||this.nt?.has(e)||(r?(n.add(e),this.st.add(e)):(n.remove(e),this.st.delete(e)))}return j}}),{I:Re}=Oe,ze=e=>e.strings===void 0,Be={},Ve=(e,t=Be)=>e._$AH=t,He=B(class extends Le{constructor(){
/**
* @license
...
outline-offset: -2px;
  ...
  `}function W(e){return xt(e,A`<ha-form
      .hass=${e.hass}
      .data=${e.data}
      .schema=${e.schema}
...
* Copyright 2020 Google LLC
* SPDX-License-Identifier: BSD-3-Clause
*/const St=B(class extends Le{constructor(e){if(super(e),e.type!==z.PROPERTY&&e.type!==z.ATTRIBUTE&&e.type!==z.BOOLEAN_ATTRIBUTE)throw Error("The `live` directive is not allowed on child or event bindings");if(!ze(e))throw Error("`live` bindings can only contain a single expression")}render(e){return e}update(e,[t]){if(t===j||t===M)return t;let n=e.element,r=e.name;if(e.type===z.PROPERTY){if(t===n[r])return j}else if(e.type===z.BOOLEAN_ATTRIBUTE){if(!!t===n.hasAttribute(r))return j}else if(e.type===z.ATTRIBUTE&&n.getAttribute(r)===t+``)return j;return Ve(e),t}}),Ct={exit:{kind:`svg`,viewBox:`0 0 36.29 29.04`,glyphPointsTo:`left`,labelKey:`icon_exit`,shapes:()=>ve`
    ...
    >${n.shapes()}</svg>
  </span>`}function Ot(e,t){let n=t.flipX?`retro-station-header__mdi retro-station-header__mdi--flip-x`:`retro-station-header__mdi`;return A`<span class="retro-station-header__tile retro-station-header__tile--mdi" role="img" aria-label=${t.ariaLabel}>
    <ha-icon class=${n} icon=${e}></ha-icon>
  </span>`}function kt(e,t){return A`<span class="retro-station-header__tile retro-station-header__tile--mdi" role="img" aria-label=${t}>
    <ha-icon class="retro-station-header__mdi" icon=${e}></ha-icon>
  </span>`}function G(e){e.key!==`Escape`&&e.key!==`Tab`&&e.stopPropagation()}function At(e,t){let n=e.trim(),r=n===``?NaN:Number(n);return n!==``&&!Number.isFinite(r)&&console.warn(`[wiener-linien-austria] walk-time "${e}" for ${t} is not a number — clearing`),Number.isFinite(r)&&r>0?Math.min(120,Math.round(r)):null}function jt(e,t){let n=(n,r)=>{let i=e();i&&t(i.map(e=>e.entity===n?r({...e}):e))};return{toggleLine:(e,t)=>n(e,e=>{let n=new Set(e.lines??[]);return n.has(t)?n.delete(t):n.add(t),n.size?e.lines=[...n]:delete e.lines,e}),setDirections:(e,t)=>n(e,e=>(t.direction===null?delete e.direction:e.direction=t.direction,Object.keys(t.lineDirections).length?e.line_directions=t.lineDirections:delete e.line_directions,e)),setWalkTime:(e,t,r)=>n(e,e=>{let n={...e.walk_times??{}};return r===null?delete n[t]:n[t]=r,Object.keys(n).length?e.walk_times=n:delete e.walk_times,e}),remove:n=>{let r=e();r&&t(r.filter(e=>e.entity!==n))}}}function Mt(e,t){let n=Array.isArray(t)?t.filter(e=>typeof e==`string`&&e.length>0):[],r=new Map(e.map(e=>[e.entity,e]));return n.map(e=>r.get(e)??{entity:e})}function Nt(e,t,n){let r={...e??{},[t]:n};return n===void 0&&delete r[t],r}function Pt(e,t,n){let r=t.et(n);return r===n?e?.localize?.(`ui.panel.lovelace.editor.card.generic.${n}`)||n:r}function Ft(e,t,n){let r=n?.[t];if(r!==void 0)return r;let i=`${t}_helper`,a=e.et(i);return a===i?void 0:a}const It=`ptMetro`;function Lt(e){switch(e){case It:return`mdi:subway-variant`;case`ptTram`:return`mdi:tram`;case`ptBusCity`:case`ptBusNight`:return`mdi:bus`;case`ptTrainS`:return`mdi:train`;default:return null}}function Rt(e){if(e?.themes?.darkMode===!0)return`dark`;if(e?.themes?.darkMode===!1)return`light`}const zt=e=>Math.min(1,Math.max(0,e)),K=e=>e<=.04045?e/12.92:((e+.055)/1.055)**2.4,Bt=e=>e<=.0031308?e*12.92:1.055*e**(1/2.4)-.055;function Vt(e){let t=e.trim();if(!t||t.includes(`var(`))return null;let n=/^#[0-9a-f]{3,8}$/i.test(t)?t.slice(1):``;if(!n){let e=``;try{let n=document.createElement(`span`).style;n.color=t,e=n.color.trim()}catch{return null}let n=/^rgba?\(([^)]+)\)$/.exec(e);if(!n?.[1])return null;let[r,i,a]=n[1].split(/[,\s/]+/).filter(Boolean).map(Number);return r===void 0||i===void 0||a===void 0||![r,i,a].every(Number.isFinite)?null:[K(r/255),K(i/255),K(a/255)]}if((n.length===3||n.length===4)&&(n=[...n.slice(0,3)].map(e=>e+e).join(``)),n.length!==6&&n.length!==8)return null;let r=Number.parseInt(n.slice(0,6),16);return Number.isFinite(r)?[K((r>>16&255)/255),K((r>>8&255)/255),K((r&255)/255)]:null}function Ht([e,t,n]){let r=Math.cbrt(.4122214708*e+.5363325363*t+.0514459929*n),i=Math.cbrt(.2119034982*e+.6806995451*t+.1073969566*n),a=Math.cbrt(.0883024619*e+.2817188376*t+.6299787005*n);return[.2104542553*r+.793617785*i-.0040720468*a,1.9779984951*r-2.428592205*i+.4505937099*a,.0259040371*r+.7827717662*i-.808675766*a]}function Ut([e,t,n]){let r=(e+.3963377774*t+.2158037573*n)**3,i=(e-.1055613458*t-.0638541728*n)**3,a=(e-.0894841775*t-1.291485548*n)**3;return[4.0767416621*r-3.3077115913*i+.2309699292*a,-1.2684380046*r+2.6097574011*i-.3413193965*a,-.0041960863*r-.7034186147*i+1.707614701*a]}const Wt=([e,t,n])=>`#`+[e,t,n].map(e=>Math.round(zt(Bt(e))*255).toString(16).padStart(2,`0`)).join(``);function Gt(e,t){if(t===void 0)return null;let n=Vt(e);if(!n)return null;let[r,i,a]=Ht(n),o=t===`dark`?Math.max(.72,r):Math.min(.45,r);if(o===r)return Wt(n);let s=Math.hypot(i,a),c=Math.atan2(a,i),l=Ut([o,s*Math.cos(c),s*Math.sin(c)]);return Wt([zt(l[0]),zt(l[1]),zt(l[2])])}const q={show_station_name:{retro:!1,flap:!0},housing:{retro:!1,flap:!0},size:{retro:`regular`,flap:`small`},unit_caption:{retro:!1,flap:!0},station_bg:{retro:`default`,flap:`line`},show_platform:{retro:!0,flap:!0}},Kt={LB:`WLB`,"25BR":`25B`};function qt(e){return Kt[e]??e}const Jt=/* @__PURE__ */ new Set([`none`,`regular`,`accessible`,...wt]);function Yt(e,t,n){if(typeof e!=`string`)return;let r=n?e.trim().slice(0,t):e.slice(0,t);return r.length>0?r:void 0}function Xt(e,t){if(!Array.isArray(e))return;let{maxCount:n,truncateTo:r,accept:i}=t,a=e.filter(e=>typeof e==`string`).map(e=>r===void 0?e.trim():e.trim().slice(0,r)).filter(e=>e.length>0&&(i===void 0||i(e))).slice(0,n);return a.length>0?a:void 0}const Zt=/^[a-z0-9_-]+:[a-z0-9_-]+$/i;function Qt(e){if(!e||typeof e!=`object`)return;let t=e,n={},r=Jt.has(t.exit)?t.exit:`none`;r!==`none`&&(n.exit=r);let i=Yt(t.text,64,!0);i!==void 0&&(n.text=i),t.show_wc===!0&&(n.show_wc=!0),t.show_escalator===!0&&(n.show_escalator=!0),t.show_elevator===!0&&(n.show_elevator=!0),t.show_clock===!0&&(n.show_clock=!0),t.show_date===!0&&(n.show_date=!0);let a=Xt(t.chips,{truncateTo:16,maxCount:6});a!==void 0&&(n.chips=a);let o=Xt(t.extra_icons,{maxCount:3,accept:e=>Zt.test(e)&&e.length<=64});if(o!==void 0&&(n.extra_icons=o),Object.keys(n).length===0)return;let s=Yt(t.date_format,32,!1);return s!==void 0&&(n.date_format=s),n}function $t(e,t){let n={};if(!e||typeof e!=`object`)return n;for(let[r,i]of Object.entries(e))t.has(r)||(n[r]=i);return n}function en(e){if(!e||typeof e!=`object`)return;let t={};for(let[n,r]of Object.entries(e)){let e=typeof r==`number`?r:typeof r==`string`?Number(r):NaN;if(!Number.isFinite(e)||e<0||e>120){console.warn(`[wiener-linien-austria] walk_times["${n}"] = ${JSON.stringify(r)} is not a finite number in 0..120 — dropping`);continue}let i=n.split(`|`),a=i.length>=3?`${i[0]}|${i[1]}`:n,o=Math.round(e),s=t[a];t[a]=s===void 0?o:Math.max(s,o)}return Object.keys(t).length?t:void 0}function tn(e,t=!1){if(!e||typeof e!=`object`)return;let n={};for(let[t,r]of Object.entries(e)){if(typeof t!=`string`||!t.length)continue;let e=t.toUpperCase();if(r===`H`||r===`R`){n[e]=r;continue}r!==void 0&&r!==``&&r!==`Both`&&console.warn(`[wiener-linien-austria] line_directions["${t}"] = ${JSON.stringify(r)} is not "H" / "R" / "Both" — dropping`)}return t||Object.keys(n).length?n:void 0}function nn(e,t){let n={entity:e};if(Array.isArray(t.lines)){let e=t.lines.filter(e=>typeof e==`string`&&e.length>0).map(qt);e.length&&(n.lines=e)}(t.direction===`H`||t.direction===`R`)&&(n.direction=t.direction);let r=tn(t.line_directions);r&&(n.line_directions=r);let i=en(t.walk_times);return i&&(n.walk_times=i),n}function rn(e,t,n={},r=`var(--primary-color)`){let i=e.toUpperCase();if(t[i]!==void 0)return{background:t[i]};if(/^N\d/.test(i))return{background:`#1b1464`,color:`#fef200`};let a=n[e]??n[i];return a?.bg?a.fg?{background:`#${a.bg}`,color:`#${a.fg}`}:{background:`#${a.bg}`}:{background:r}}function an(e,t,n={},r,i=`var(--primary-color)`){let a=rn(e,t,n,i);return{fill:a.background,ink:a.color,text:Gt(a.background,r)??void 0}}const on=[{key:`show_wc`,icon:`mdi:human-male-female`,labelKey:`show_wc_short`},{key:`show_escalator`,icon:`mdi:escalator`,labelKey:`show_escalator_short`},{key:`show_elevator`,icon:`mdi:elevator`,labelKey:`show_elevator_short`},{key:`show_clock`,icon:`mdi:clock-outline`,labelKey:`show_clock_short`},{key:`show_date`,icon:`mdi:calendar`,labelKey:`show_date_short`}],sn=[{value:`regular`,icon:`mdi:exit-run`,labelKey:`header_exit_regular`},{value:`accessible`,icon:`mdi:wheelchair-accessibility`,labelKey:`header_exit_accessible`},...wt.map(e=>({value:e,icon:e,labelKey:Tt[e].labelKey})),{value:`none`,icon:`mdi:close-circle-outline`,labelKey:`header_exit_none`}];function cn(e,t,n){let r=[];if(!e)return[{label:t,kind:`text`,name:t}];if(e.exit&&e.exit!==`none`){let t=sn.find(t=>t.value===e.exit);r.push({label:``,icon:t?.icon??e.exit,kind:`icon`,name:t?n(t.labelKey):e.exit})}e.text&&r.push({label:e.text,kind:`text`,name:e.text});for(let t of on)e[t.key]&&r.push({label:``,icon:t.icon,kind:`icon`,name:n(t.labelKey)});for(let t of e.extra_icons??[])r.push({label:``,icon:t,kind:`icon`,name:t});for(let t of e.chips??[])r.push({label:t,kind:`chip`,name:t});return r.length||r.push({label:t,kind:`text`,name:t}),r}function ln(e,t){let n=(e.selected===`header_left`?e.left:e.right)??{},r=e.et(`header_slot_empty`),i=(n,r)=>t.patch(e.selected,n,r);return A`
    <div class="wl-strip">
      ...
      <div class="wl-slot">
        <div class="wl-group">
          ...
          <div class="wl-pict-grid">
            ${sn.map(t=>{let r=(n.exit??`none`)===t.value,a=e.et(t.labelKey);return A`<button
                type="button"
                class="wl-pict"
        ...
        <div class="wl-group">
          ...
          <div class="wl-tray">
            ${on.map(t=>{let r=!!n[t.key],a=e.et(t.labelKey);return A`<button
                type="button"
                class="wl-tray-btn"
                aria-pressed=${r?`true`:`false`}
                aria-label=${a}
  ...
  `}function un(e,t,n,r){let i=e===`header_left`?t.left:t.right,a=t.selected===e,o=cn(i,r,t.et),s=t.et(e===`header_left`?`header_left`:`header_right`);return A`<button
    type="button"
  ...
  </button>`}function dn(e,t,n){let r=e.chips??[],i=e.extra_icons??[];return A`
    <div class="wl-group">
      <span class="wl-label"
      ...
      ${r.length<6?A`<input
            ...
            @keydown=${e=>{if(G(e),e.key!==`Enter`)return;let t=e.target,i=t.value.trim();i&&(n(`chips`,[...r,i].slice(0,6)),t.value=``)}}
            @keyup=${G}
            @keypress=${G}
          />`:M}
    </div>
  `}function fn(e,t){let n=e.filter((e,n)=>n!==t);return n.length?n:void 0}function pn(e){return xt({title:e.et(`section_header`),hint:e.et(`section_header_hint`)},A`
      <ha-form
        .hass=${e.hass}
        ...
        @value-changed=${t=>{t.stopPropagation(),e.onChange(t.detail.value)}}
      ></ha-form>
      ${e.showHeader?ln({left:e.left,right:e.right,selected:e.selected,et:e.et},{selectSide:e.selectSide,patch:(t,n,r)=>e.onChange({[t]:Nt(e.currentSide(t),n,r)})}):M}
    `)}function mn(e,t){return`${e}|${t}`}function hn(e){if(!Array.isArray(e))return`H`;let t=e,n=t.some(e=>e.direction===`H`),r=t.some(e=>e.direction===`R`);return!n&&r?`R`:`H`}function gn(e){let t=[],n=/* @__PURE__ */ new Set;for(let r of e?.departures??[]){let e=String(r.direction??``),i=`${r.line}|${e}|${r.towards}`;n.has(i)||(n.add(i),t.push({line:r.line,direction:e,towards:r.towards,type:r.type}))}return t.sort((e,t)=>e.line===t.line?e.towards.localeCompare(t.towards):e.line.localeCompare(t.line)),t}function _n(e){let t=/* @__PURE__ */ new Map;for(let n of e?.departures??[]){let e=String(n.direction??``),r=mn(n.line,e),i=t.get(r);i||(i={line:n.line,direction:e,type:n.type,termini:[]},t.set(r,i)),n.towards&&!i.termini.includes(n.towards)&&i.termini.push(n.towards)}let n=Array.from(t.values());return n.sort((e,t)=>e.line===t.line?e.direction.localeCompare(t.direction):e.line.localeCompare(t.line)),n}function vn(e,t){if(!e.length)return t.full;let n=e.slice(0,3).join(` / `),r=e.length>3?` +${e.length-3}`:``;return`${t.short}: ${n}${r}`}function yn(e,t){let n=/* @__PURE__ */ new Set;for(let r of e?.tracked_line_keys??[]){let[e,i]=r.split(`|`,2);t&&e!==t||(i===`H`||i===`R`)&&n.add(i)}if(n.size===0)for(let r of e?.departures??[])t&&r.line!==t||(r.direction===`H`||r.direction===`R`)&&n.add(r.direction);let r=[...n];return{available:n,unknown:n.size===0,oneWay:n.size===1?r[0]??null:null}}function bn(e,t){if(t.size===0)return[...e];let n=e.filter(e=>t.has(e));for(let e of t)n.includes(e)||n.push(e);return n}function xn(e){if(e?.tracked_lines?.length)return[...e.tracked_lines].sort();let t=/* @__PURE__ */ new Set;if(e?.lines_at_stop?.length)for(let n of e.lines_at_stop)t.add(n);for(let n of e?.departures??[])n.line&&t.add(n.line);return Array.from(t).sort()}function Sn(e,t){let{lines:n,direction:r,line_directions:i,walk_times:a,accessibility_only:o}=t,s=n&&n.length?new Set(n.map(qt)):null;return e.filter(e=>{if(s&&!s.has(e.line))return!1;let t=i?.[e.line]??r;if(t&&e.direction!==t)return!1;if(a){let t=a[mn(e.line,String(e.direction??``))];if(typeof t==`number`&&e.countdown<t)return!1}return!(o&&!e.barrier_free)})}function Cn(e,t){let{lines:n,picked:r,lineDirections:i,stopDirection:a}=t,o=e=>i[e]??a,s=_n(e).filter(e=>{if(r.size>0&&!r.has(e.line))return!1;let t=o(e.line);return!t||e.direction===t}),c=new Set(s.map(e=>e.line)),l=bn(n,r),u=[];for(let e of l){if(c.has(e))continue;let t=o(e);for(let n of t?[t]:[`H`,`R`])u.push({line:e,direction:n,type:``,termini:[]})}return[...s,...u].sort((e,t)=>e.line===t.line?e.direction.localeCompare(t.direction):e.line.localeCompare(t.line))}function wn(e){return{"--wl-chip-color":e.fill,...e.text?{"--wl-chip-text":e.text}:{},...e.ink?{"--wl-chip-ink":e.ink}:{}}}function Tn(e){return{background:e.fill,...e.ink?{"--wl-chip-ink":e.ink}:{}}}function En(e,t){return e?.states?.[t]?.attributes}function Dn(e,t,n){let r=/* @__PURE__ */ new Set;for(let i of e)i.direction===t&&(n&&i.line!==n||i.towards&&r.add(i.towards));return[...r].sort()}function On(e,t){return!e.singleLine&&bn(t.lines,t.picked).length>=2}function kn(e,t,n,r){let i=En(e,t.entity),a=!i,o=i?.stop_name||t.entity,s=i?.line_colors??{},c=Rt(e),l=e=>an(e,n.lineColorOverrides,s,c,`#5b6470`),u=new Set(t.lines??[]),d=xn(i),f=u.size?[.../* @__PURE__ */ new Set([...d,...u])].sort():d,p=gn(i),m=/* @__PURE__ */ new Map;for(let e of i?.departures??[])e.line&&e.type&&!m.has(e.line)&&m.set(e.line,e.type);let h=e=>({full:n.t(e===`H`?`dir_h`:`dir_r`),short:n.t(e===`H`?`dir_h_short`:`dir_r_short`)});return A`
    <section class="wl-section">
      <header class="wl-section-header">
      ...
      <div class="wl-stop-body">
        ${a?An(t,n,r):M}
        ${jn(t,n,r,{lines:f,picked:u,colorOf:l,typeByLine:m})}
        ${!a&&f.length?On(n,{lines:f,picked:u})?Nn(t,n,r,{attrs:i,triplets:p,picked:u,lines:f,colorOf:l,dirStrings:h}):Mn(t,n,r,{attrs:i,triplets:p,picked:u,lines:f,dirStrings:h}):M}
        ${a?M:Pn(t,n,r,{attrs:i,picked:u,colorOf:l,lines:f,dirStrings:h})}
      </div>
    </section>
  `}function An(e,t,n){return A`
  ...
  `}function jn(e,t,n,r){let{lines:i,picked:a,colorOf:o,typeByLine:s}=r,c=a.size?t.et(`lines_selected`).replace(`{n}`,String(a.size)).replace(`{total}`,String(i.length)):t.et(`lines_empty_means_all`);return A`
    <div class="wl-group">
      ...
      ${i.length?A`<div class="wl-chips">
            ${i.map(r=>{let i=t.singleLine?a.has(r):a.size===0||a.has(r),c=Lt(s.get(r));return A`<button
                type="button"
                class="wl-chip"
                style=${H(wn(o(r)))}
  ...
  `}function Mn(e,t,n,r){let{attrs:i,triplets:a,picked:o,lines:s,dirStrings:c}=r,l=bn(s,o),u=l.length===1?l[0]:void 0,d=e.direction??null,f=yn(i,u),p=f.available.has(`H`),m=f.available.has(`R`),h=f.oneWay!==null,g=d===`H`||d===null&&f.oneWay===`H`,_=d===`R`||d===null&&f.oneWay===`R`,v=d===null&&!h,y=t=>{let r={};for(let[t,n]of Object.entries(e.line_directions??{}))l.includes(t)||(r[t]=n);n.setDirections(e.entity,{direction:t,lineDirections:r})},ee=e=>f.unknown||f.available.has(e)?vn(Dn(a,e,u),c(e)):`${c(e).short}: ${t.et(`direction_not_served`)}`,b=f.oneWay!==null&&l.length===1?t.et(`direction_note_one_way`).replace(`{line}`,l[0]??``):``;return A`
    <div class="wl-group">
      <span class="wl-label">${t.et(`direction_label`)}</span>
      <div class="wl-dirs">
        ${J({label:ee(`H`),active:g,disabled:!f.unknown&&!p,title:p||f.unknown?t.t(`dir_h`):t.et(`direction_unavailable`),onClick:()=>y(`H`)})}
        ${J({label:ee(`R`),active:_,disabled:!f.unknown&&!m,title:m||f.unknown?t.t(`dir_r`):t.et(`direction_unavailable`),onClick:()=>y(`R`)})}
        ${t.singleLine?M:J({label:t.t(`dir_both`),active:v,disabled:h,title:h?t.et(`direction_unavailable`):t.t(`dir_both`),onClick:()=>y(null)})}
      </div>
      ${b?A`<span class="wl-note">${b}</span>`:M}
    </div>
  `}function J(e){return A`<button
    type="button"
  ...
  </button>`}function Nn(e,t,n,r){let{attrs:i,triplets:a,picked:o,lines:s,colorOf:c,dirStrings:l}=r,u=bn(s,o),d=e.line_directions??{},f=e.direction??null,p=e.direction===void 0&&e.line_directions!==void 0&&Object.keys(e.line_directions).length===0,m=e=>d[e]??f,h=(t,r)=>{let i={};for(let e of u){let n=e===t?r:m(e);n&&(i[e]=n)}for(let[e,t]of Object.entries(d))u.includes(e)||(i[e]=t);n.setDirections(e.entity,{direction:null,lineDirections:i})};return A`
    <div class="wl-group">
      <span class="wl-label">${t.et(`direction_label`)}</span>
      ${u.map(e=>{let n=yn(i,e),r=p?null:m(e),o=n.available.has(`H`),s=n.available.has(`R`),u=n.oneWay!==null,d=n.unknown,f=n=>t.et(`per_line_direction_aria`).replace(`{line}`,e).replace(`{direction}`,n===null?t.t(`dir_both`):vn(Dn(a,n,e),l(n)));return A`
          <div class="wl-override-row">
            <span class="wl-badge" style=${H(Tn(c(e)))}
              >${e}</span
            >
            <div class="wl-dirs">
              ${J({label:l(`H`).short,active:r===`H`||r===null&&n.oneWay===`H`,disabled:!d&&!o,compact:!0,title:Dn(a,`H`,e).join(` / `)||t.t(`dir_h`),ariaLabel:f(`H`),onClick:()=>h(e,`H`)})}
              ${J({label:l(`R`).short,active:r===`R`||r===null&&n.oneWay===`R`,disabled:!d&&!s,compact:!0,title:Dn(a,`R`,e).join(` / `)||t.t(`dir_r`),ariaLabel:f(`R`),onClick:()=>h(e,`R`)})}
              ${J({label:``,icon:`mdi:swap-horizontal`,active:r===null&&(!u||p),disabled:u&&!p,compact:!0,title:t.t(`dir_both`),ariaLabel:f(null),onClick:()=>h(e,null)})}
            </div>
          </div>
        `})}
    </div>
  `}function Pn(e,t,n,r){let{attrs:i,picked:a,colorOf:o,lines:s,dirStrings:c}=r,l=Cn(i,{lines:s,picked:a,lineDirections:e.line_directions??{},stopDirection:e.direction??null});return l.length?A`
    <div class="wl-group wl-divide">
      ...
      <div class="wl-walk-list">
        ${l.map(r=>{let i=mn(r.line,r.direction),a=e.walk_times?.[i],s=r.termini.length?r.termini.join(` / `):r.direction===`H`||r.direction===`R`?c(r.direction).full:``,l=t.et(`walk_time_aria`).replace(`{line}`,r.line).replace(`{towards}`,s),u=t=>{let r=(a??0)+t;n.setWalkTime(e.entity,i,r<1?null:Math.min(120,r))};return A`
            <div class="wl-walk-row">
              <span class="wl-badge" style=${H(Tn(o(r.line)))}
                >${r.line}</span
              >
              <span
                class="wl-walk-dest"
  ...
  `:M}function Fn(e,t,n){e.dispatchEvent(new CustomEvent(t,{detail:n,bubbles:!0,composed:!0}))}function In(e){return Rn(e,e=>typeof e.diva==`number`&&Array.isArray(e.departures)&&!!e.next_by_line&&typeof e.next_by_line==`object`)}function Ln(e,t=[]){let n=new Set(In(e));for(let e of t)e&&n.add(e);return[...n].sort()}function Rn(e,t){if(!e)return[];let n=[];for(let[r,i]of Object.entries(e.states??{}))r.startsWith(`sensor.`)&&t(i?.attributes??{})&&n.push(r);return n.sort()}function zn(e,t){return!e||!t?{}:e.states?.[t]?.attributes?.line_colors??{}}function Bn(e,t){if(!e)return{};let n={};for(let r of t)for(let[t,i]of Object.entries(zn(e,r)))t in n||(n[t]=i);return n}const Vn=/* @__PURE__ */ new Set([`small`,`medium`,`regular`]),Hn=/* @__PURE__ */ new Set([`line`,`white`,`black`]);function Un(e){return typeof e==`string`&&(Hn.has(e)||e.startsWith(`line:`)&&e.length>5)?e:q.station_bg.flap}function Wn(e,t){return typeof e==`boolean`?e:t}function Gn(e){if(typeof e==`string`)return e.startsWith(`sensor.`)?{entity:e}:null;if(!e||typeof e!=`object`)return null;let t=e,n=typeof t.entity==`string`?t.entity:null;return n?.startsWith(`sensor.`)?nn(n,t):null}const Kn=/* @__PURE__ */ new Set([`type`,`entities`,`entity`,`line`,`lines`,`direction`,`walk_times`,`size`,`max_rows`,`show_platform`,`show_station_name`,`show_station_header`,`station_bg`,`show_min_unit`,`show_accessibility`,`accessibility_only`,`show_header`,`header_left`,`header_right`,`hide_attribution`,`show_line_column`,`line_pill`,`housing`]);function qn(e){let t=Vn.has(e.size)?e.size:q.size.flap,n=Number(e.max_rows),r=Number.isFinite(n);e.max_rows!==void 0&&!r&&console.warn(`[wiener-linien-austria-flap-card] max_rows ${JSON.stringify(e.max_rows)} is not a number — falling back to 2`);let i=r?Math.max(1,Math.min(8,Math.round(n))):2,a=[];if(Array.isArray(e.entities))a=e.entities;else if(typeof e.entity==`string`){let t;Array.isArray(e.lines)?t=e.lines.filter(e=>typeof e==`string`&&e.length>0):typeof e.line==`string`&&e.line&&(t=[e.line]),a=[{entity:e.entity,...t&&t.length?{lines:t}:{},...e.direction===void 0?{}:{direction:e.direction},...e.walk_times===void 0?{}:{walk_times:e.walk_times}}]}let o=[],s=/* @__PURE__ */ new Set;for(let e of a){let t=Gn(e);if(!t){console.warn(`[wiener-linien-austria-flap-card] dropping malformed stop entry`,e);continue}s.has(t.entity)||(s.add(t.entity),o.push(t))}let c=$t(e,Kn),l=Un(e.station_bg),u=e.show_station_header,d=typeof e.show_station_name==`boolean`?e.show_station_name:typeof u==`boolean`?u:q.show_station_name.flap;return{...c,type:e.type||`custom:wiener-linien-austria-flap-card`,entities:o,size:t,max_rows:i,show_platform:Wn(e.show_platform,q.show_platform.flap),show_station_name:d,station_bg:l,show_min_unit:Wn(e.show_min_unit,q.unit_caption.flap),show_accessibility:Wn(e.show_accessibility,!0),accessibility_only:e.accessibility_only===!0,show_header:e.show_header===!0,header_left:Qt(e.header_left),header_right:Qt(e.header_right),hide_attribution:e.hide_attribution===!0,show_line_column:e.show_line_column===void 0?e.line_pill!==!0:e.show_line_column===!0,housing:Wn(e.housing,q.housing.flap)}}function Y(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a}let X=class extends L{constructor(...e){super(...e),this._tab=`stops`,this._headerSide=`header_left`,this._onEntitiesChanged=e=>{e.stopPropagation(),this._config&&this._commit(qn({...this._config,entities:Mt(this._config.entities,e.detail.value.entities)}))},this._computeLabel=e=>Pt(this.hass,this._i18n,e.name),this._computeHelper=e=>{let{et:t}=this._i18n;return Ft(this._i18n,e.name,{...this._config?.show_accessibility?{}:{accessibility_only:t(`accessibility_only_requires`)}})}}setConfig(e){if(!e||typeof e!=`object`)throw Error(`wiener-linien-austria-flap-card-editor: config must be an object`);if(e.entity!==void 0&&typeof e.entity!=`string`)throw Error(`wiener-linien-austria-flap-card-editor: 'entity' must be a string`);this._config=qn(e)}shouldUpdate(e){if(!this._config)return!1;if(e.has(`_config`)||e.has(`_tab`)||e.has(`_headerSide`))return!0;let t=e.get(`hass`);if(!t||!this.hass)return!0;let n=this._config.entities.map(e=>e.entity);return n.length===0||n.some(e=>t.states[e]!==this.hass.states[e])}get _i18n(){return vt(`flap`,this.hass?.language)}_commit(e){this._config=e,Fn(this,`config-changed`,{config:e})}_patch(e){this._config&&this._commit(qn({...this._config,...e}))}get _stopCallbacks(){return jt(()=>this._config?.entities,e=>{this._config&&this._commit({...this._config,entities:e})})}render(){if(!this._config)return M;let{et:e}=this._i18n;return A`
      <div class="wl-editor">
    ...
    `}_renderActiveTab(){switch(this._tab){case`stops`:return this._renderStops();case`display`:return this._renderDisplay();case`tweaks`:return this._renderTweaks()}}_renderStops(){let e=this._config,{t,et:n}=this._i18n;return A`
      <ha-form
        .hass=${this.hass}
        .data=${{entities:e.entities.map(e=>e.entity)}}
        .schema=${[{name:`entities`,required:!0,selector:{entity:{multiple:!0,include_entities:Ln(this.hass,e.entities.map(e=>e.entity))}}}]}
        .computeLabel=${this._computeLabel}
        .computeHelper=${this._computeHelper}
        @value-changed=${this._onEntitiesChanged}
      ></ha-form>
      ${e.entities.map((r,i)=>kn(this.hass,r,{index:i+1,total:e.entities.length,lineColorOverrides:{},t,et:n},this._stopCallbacks))}
    `}_renderDisplay(){let e=this._config,{et:t}=this._i18n,n={hass:this.hass,computeLabel:this._computeLabel,computeHelper:this._computeHelper,onChange:e=>this._patch(e)};return A`
      ${pn({hass:this.hass,showHeader:e.show_header,left:e.header_left,right:e.header_right,selected:this._headerSide,et:t,computeLabel:this._computeLabel,computeHelper:this._computeHelper,currentSide:e=>this._config?.[e],onChange:e=>this._patch(e),selectSide:e=>{this._headerSide=e}})}
      ${W({...n,title:t(`section_station`),data:{show_station_name:e.show_station_name,station_bg:e.station_bg},schema:[{name:`show_station_name`,selector:{boolean:{}}},{name:`station_bg`,selector:{select:{mode:`dropdown`,options:this._stationBgOptions()}}}]})}
      ${W({...n,title:t(`section_departure_row`),hint:t(`section_board`),data:{max_rows:e.max_rows,show_platform:e.show_platform,show_accessibility:e.show_accessibility,accessibility_only:e.accessibility_only},schema:[{name:`max_rows`,selector:{number:{min:1,max:8,step:1,mode:`slider`}}},{name:`show_platform`,selector:{boolean:{}}},{name:`show_accessibility`,selector:{boolean:{}}},{name:`accessibility_only`,disabled:!e.show_accessibility,selector:{boolean:{}}}]})}
    `}_renderTweaks(){let e=this._config,{et:t}=this._i18n,n={hass:this.hass,computeLabel:this._computeLabel,computeHelper:this._computeHelper,onChange:e=>this._patch(e)};return A`
      ${W({...n,title:t(`section_board`),data:{size:e.size,show_min_unit:e.show_min_unit,show_line_column:e.show_line_column,housing:e.housing},schema:[{name:`size`,selector:{select:{mode:`dropdown`,options:[{value:`small`,label:t(`size_small`)},{value:`medium`,label:t(`size_medium`)},{value:`regular`,label:t(`size_regular`)}]}}},{name:`show_min_unit`,selector:{boolean:{}}},{name:`show_line_column`,selector:{boolean:{}}},{name:`housing`,selector:{boolean:{}}}]})}
      ${W({...n,title:t(`section_footer`),data:{hide_attribution:e.hide_attribution},schema:[{name:`hide_attribution`,selector:{boolean:{}}}]})}
    `}_stationBgOptions(){let{et:e}=this._i18n,t=[{value:`line`,label:e(`station_bg_line`)}],n=/* @__PURE__ */ new Set;for(let e of this._config?.entities??[]){let t=this.hass?.states?.[e.entity]?.attributes,r=e.lines&&e.lines.length>0?e.lines:t?.tracked_lines;for(let e of r??[])typeof e==`string`&&e&&n.add(e)}if(n.size===0){let e=this._config?.entities?.[0]?.entity,t=e?this.hass?.states?.[e]?.attributes?.line_colors:void 0;for(let e of Object.keys(t??{}))n.add(e)}for(let e of[...n].sort())t.push({value:`line:${e}`,label:e});return t.push({value:`white`,label:e(`station_bg_white`)}),t.push({value:`black`,label:e(`station_bg_black`)}),t}static{this.styles=[gt,ht,_t]}};Y([Ie({attribute:!1})],X.prototype,`hass`,void 0),Y([R()],X.prototype,`_config`,void 0),Y([R()],X.prototype,`_tab`,void 0),Y([R()],X.prototype,`_headerSide`,void 0),X=Y([Ne(`wiener-linien-austria-flap-card-editor`)],X);function Jn(e){if(!e)return null;let t=Date.parse(e);if(!Number.isFinite(t))return null;let n=new Date(t);return`${String(n.getHours()).padStart(2,`0`)}:${String(n.getMinutes()).padStart(2,`0`)}`}function Z(e){return String(e).padStart(2,`0`)}function Yn(e,t,n=`de`){if(!t)return``;let r=n===`en`?`en-GB`:`de-AT`,i=()=>e.toLocaleDateString(r,{weekday:`long`}),a=()=>e.toLocaleDateString(r,{weekday:`short`}),o=()=>e.toLocaleDateString(r,{month:`long`}),s=()=>e.toLocaleDateString(r,{month:`short`}),c=``,l=0;for(;l<t.length;){let n=t[l];if(n===`\\`&&l+1<t.length){c+=t[l+1],l+=2;continue}switch(n){case`d`:c+=Z(e.getDate());break;case`j`:c+=String(e.getDate());break;case`D`:c+=a();break;case`l`:c+=i();break;case`m`:c+=Z(e.getMonth()+1);break;case`n`:c+=String(e.getMonth()+1);break;case`M`:c+=s();break;case`F`:c+=o();break;case`Y`:c+=String(e.getFullYear());break;case`y`:c+=Z(e.getFullYear()%100);break;case`H`:c+=Z(e.getHours());break;case`G`:c+=String(e.getHours());break;case`h`:c+=Z((e.getHours()+11)%12+1);break;case`g`:c+=String((e.getHours()+11)%12+1);break;case`i`:c+=Z(e.getMinutes());break;case`s`:c+=Z(e.getSeconds());break;default:c+=n??``}l++}return c}function Xn(e,t,n){if(!e||!t)return null;let r=Date.parse(e);return Number.isFinite(r)?Yn(new Date(r),t,n):null}function Zn(e,t,n,r,i){let a=M;if(e.exit===`regular`||e.exit===`accessible`){let n=e.exit===`regular`?`exit`:`exit-access`;a=Dt(n,{ariaLabel:r(`header.${Ct[n].labelKey}`),flipX:Ct[n].glyphPointsTo!==t})}else if(e.exit&&Et(e.exit)){let n=Tt[e.exit];a=Ot(e.exit,{ariaLabel:r(`header.${n.labelKey}`),flipX:n.glyphPointsTo!==void 0&&n.glyphPointsTo!==t})}let o=e.text?A`<span class="retro-station-header__text">${e.text}</span>`:M,s=e=>Dt(e,{ariaLabel:r(`header.${Ct[e].labelKey}`)}),c=e.show_wc?s(`wc`):M,l=e.show_escalator?s(`escalator`):M,u=e.show_elevator?s(`elevator`):M,d=(e.extra_icons??[]).map(e=>kt(e,e)),f=[...d].reverse(),p=(e.chips??[]).map(e=>A`<span class="retro-station-header__chip">${e}</span>`),m=[...p].reverse(),h=e.show_clock?Jn(n):null,g=h?A`<span
      ...
      >
        ...
        ></ha-icon>
        <span>${h}</span>
      </span>`:M,_=e.show_date?Xn(n,e.date_format??`d.m.Y`,i):null,v=_?A`<span
        class="retro-station-header__chip retro-station-header__chip--date"
        >${_}</span
      >`:M;return t===`left`?A`${a}${o}${u}${l}${c}${d}${p}${v}${g}`:A`${g}${v}${m}${f}${c}${l}${u}${o}${a}`}function Qn(e){let{left:t,right:n,serverTime:r,t:i,lang:a}=e;return!t&&!n?M:A`
    <div class="retro-station-header" role="group">
      ...
      <div class="retro-station-header__side retro-station-header__side--right">
        ${n?Zn(n,`right`,r,i,a):M}
      </div>
    </div>
  `}const $n=`ABCDEFGHIJKLMNOPQRSTUVWXYZÄÖÜß`,er=`0123456789`;function tr(e,t,n){let r=((e.includes(t)?e.indexOf(t):e.length)+1)%(e.length+1);return r===e.length?n:e[r]}function nr(e,t){if(e===t)return t;let n=$n.includes(e),r=er.includes(e),i=$n.includes(t),a=er.includes(t);return(n||i)&&!r&&!a?tr($n,e,t):(r||a)&&!n&&!i?tr(er,e,t):t}function Q(e,t){return`row${e}-${t}`}const rr={small:22,medium:28,regular:32};function ir(e){let t=typeof e==`number`&&Number.isFinite(e)?e:null;return t===null?`--`:String(t<=0?0:t).padStart(2,` `)}{let e=window;e.customCards=e.customCards??[],e.customCards.some(e=>e.type===`wiener-linien-austria-flap-card`)||e.customCards.push({type:`wiener-linien-austria-flap-card`,name:`Wiener Linien Austria — Flap Board`,description:ut(`picker_flap`),preview:!0,getEntitySuggestion:(e,t)=>!t.startsWith(`sensor.`)||e?.entities?.[t]?.platform!==`wiener_linien_austria`?null:{config:{type:`custom:wiener-linien-austria-flap-card`,entities:[t]}}})}let $=class extends L{constructor(...e){super(...e),this._versionMismatch=null,this._displayed={},this._target={},this._justFlipped={},this._marchTimer=null,this._versionCheckDone=!1,this._fallbackWarned=!1}setConfig(e){if(!e||typeof e!=`object`)throw Error(`wiener-linien-austria-flap-card: config must be an object`);if(e.entity!==void 0&&typeof e.entity!=`string`)throw Error(`wiener-linien-austria-flap-card: 'entity' must be a string`);let t=qn(e);if((Array.isArray(e.entities)?e.entities.length:typeof e.entity==`string`&&e.entity?1:0)>0&&t.entities.length===0)throw Error("wiener-linien-austria-flap-card: every configured entity was rejected (must start with `sensor.`) — see browser console for per-entry details");this._config=t,this._clearFlipTimer(),this._displayed={},this._target={},this._justFlipped={}}getCardSize(){return 3}getGridOptions(){return{columns:12,rows:`auto`,min_columns:6,min_rows:3}}static getConfigElement(){return document.createElement(`wiener-linien-austria-flap-card-editor`)}static getStubConfig(e){let t=In(e)[0];return t?{entity:t,direction:hn(e?.states?.[t]?.attributes?.departures)}:{}}connectedCallback(){super.connectedCallback(),We(),!this._versionCheckDone&&this.hass?.callWS&&(this._versionCheckDone=!0,this._checkCardVersion()),this._hasPendingFlips()&&this._ensureMarchTimer()}_hasPendingFlips(){return Object.entries(this._target).some(([e,t])=>this._displayed[e]!==t)}disconnectedCallback(){super.disconnectedCallback(),this._clearFlipTimer()}shouldUpdate(e){if(!this._config)return!1;if(e.has(`_config`)||e.has(`_versionMismatch`)||e.has(`_displayed`)||e.has(`_target`)||e.has(`_justFlipped`))return!0;let t=e.get(`hass`);if(!t||!this.hass)return!0;let n=this._resolveStopEids();return n.length!==0&&n.some(e=>t.states[e]!==this.hass.states[e])}willUpdate(e){if(!this._config||!e.has(`hass`)&&!e.has(`_config`))return;let t=this._gatherRows(),n=this._maxDestLen(t),r=this._maxLineLen(t);for(let e=0;e<t.length;e++){let i=t[e];i&&(this._diffFlipField(Q(e,`line`),(i.line??`?`).toUpperCase().padStart(r,` `)),this._diffFlipField(Q(e,`dest`),(i.towards??``).toUpperCase().padEnd(n,` `)),this._diffFlipField(Q(e,`cd`),ir(i.countdown)))}for(let e=t.length;e<this._config.max_rows;e++)this._diffFlipField(Q(e,`line`),null),this._diffFlipField(Q(e,`dest`),null),this._diffFlipField(Q(e,`cd`),null)}_clearFlipTimer(){this._marchTimer!==null&&(clearInterval(this._marchTimer),this._marchTimer=null)}_diffFlipField(e,t){if(t===null){if(e in this._displayed){let{[e]:t,...n}=this._displayed;this._displayed=n}if(e in this._target){let{[e]:t,...n}=this._target;this._target=n}if(e in this._justFlipped){let{[e]:t,...n}=this._justFlipped;this._justFlipped=n}return}if(this._displayed[e]===void 0){this._displayed={...this._displayed,[e]:t},this._target={...this._target,[e]:t};return}this._target[e]!==t&&(this._target={...this._target,[e]:t},this._ensureMarchTimer())}_ensureMarchTimer(){this._marchTimer===null&&(this._marchTimer=setInterval(()=>this._marchTick(),130))}_marchTick(){let e={...this._displayed},t={},n=!1;for(let[r,i]of Object.entries(this._target)){let a=e[r]??``;if(a===i)continue;let o=Math.max(a.length,i.length),s=[],c={};for(let e=0;e<o;e++){let t=a[e]??` `,n=i[e]??` `;t===n?s.push(t):(c[e]=t,s.push(nr(t,n)))}e[r]=s.join(``),Object.keys(c).length>0&&(t[r]=c,n=!0)}this._displayed=e,this._justFlipped=t,n||this._clearFlipTimer()}async _checkCardVersion(){this._versionMismatch=await dt(this.hass,`wiener_linien_austria/flap_card_version`,`2.1.0`)}_resolveStopEids(){let e=this._config?.entities??[],t=this.hass?.states,n=e.map(e=>e.entity).filter(e=>t?.[e]);if(n.length===0&&e.length===0){let e=In(this.hass)[0];e&&n.push(e)}return n.length===0&&e.length>0&&!this._fallbackWarned&&(this._fallbackWarned=!0,console.warn(`[wiener-linien-austria-flap-card] none of the configured entities exist in hass.states (${e.map(e=>e.entity).join(`, `)})`)),n}_maxDestLen(e){return Math.max(0,...e.map(e=>(e.towards??``).length))}_maxLineLen(e){return Math.max(0,...e.map(e=>(e.line??`?`).length))}_gatherRows(){if(!this._config)return[];let e=this._config.entities??[],t=this._config.accessibility_only,n=[];for(let r of e){let e=this.hass?.states?.[r.entity]?.attributes??{},i=Sn(Array.isArray(e.departures)?e.departures:[],{direction:r.direction,lines:r.lines,line_directions:r.line_directions,walk_times:r.walk_times,accessibility_only:t});n.push(...i)}let r=e=>Number.isFinite(e.countdown)?e.countdown:1/0;return n.sort((e,t)=>r(e)-r(t)),n.slice(0,this._config.max_rows)}_t(e,t){return U(`flap.${e}`,{hassLanguage:this.hass?.language},t)}render(){if(!this._config)return M;let e=this._config,t=this._resolveStopEids(),n=this._gatherRows(),r=t[0]??``,i=r?this.hass?.states?.[r]?.attributes??{}:{},a=i.stop_name||i.friendly_name||``,o=i.server_time,s=Bn(this.hass,t),c=e.show_platform&&n.some(e=>e.platform),l=(n[0]?.type??``)===It,u=this._t(l?`gleis`:`steig`),d=this.hass?.themes?.darkMode===!1,f={flap:!0,[`flap--size-${e.size}`]:e.size!==`regular`,"flap--has-platform":c,"flap--light":d,"flap--no-line":!e.show_line_column,"flap--no-housing":!e.housing},p=this._resolveStationHeaderStyle(e.station_bg,e.entities,n,s),m=e.show_header?Qn({left:e.header_left,right:e.header_right,serverTime:o,t:e=>this._t(e),lang:this.hass?.language}):M,h=e.hide_attribution?``:typeof i.attribution==`string`&&i.attribution||`Datenquelle: Wiener Linien (data.wien.gv.at), CC BY 4.0`;return A`
      <ha-card style="padding:0;overflow:hidden;">
        <div class=${V(f)}>
          ${mt(this._versionMismatch,e=>this._t(e),`flap-banner`)}
          ${m}
          ${e.show_station_name?A`<div
                class="flap-header"
                role="group"
                style=${H(p)}
              >
          ...
          <div class="flap-panel">
            ...
            ${h?A`<div class="flap-foot">${h}</div>`:M}
          </div>
        </div>
      </ha-card>
    `}_resolveStationHeaderStyle(e,t,n,r){if(e===`white`)return{background:`#ffffff`,color:`#1a1410`};if(e===`black`)return{background:`#000000`,color:`var(--flap-cream-hi)`};let i;if(e===`line`?i=t[0]?.lines?.[0]??n[0]?.line:e.startsWith(`line:`)&&(i=e.slice(5)),!i)return{background:`var(--wl-orange)`};let a=rn(i,{},r);return{background:a.background===`var(--primary-color)`?`var(--wl-orange)`:a.background,color:`var(--flap-on-color-fg)`}}_renderBoard(e,t,n,r,i,a,o){let s=this._maxDestLen(t),c=this._maxLineLen(t);if(e.length===0)return A`<div class="flap-empty">${this._t(`no_entity`)}</div>`;if(t.length===0){let t=e.some(e=>{let t=this.hass?.states?.[e]?.attributes??{};return Array.isArray(t.departures)&&t.departures.length>0}),n=e.some(e=>{let t=this.hass?.states?.[e]?.attributes??{};return typeof t.stale_departures==`number`&&t.stale_departures>0}),r=t?`no_data`:n?`stale_feed`:`betriebsschluss`;return A`<div class="flap-empty">${this._t(r)}</div>`}let l=rr[this._config?.size??`regular`],u=s*l+Math.max(0,s-1)*2,d=i?u+6+l:u;return A`
      <div
        class=${V({"flap-board":!0,"flap-board--has-platform":n,"flap-board--no-line":a})}
        role="list"
        aria-label=${this._t(`departures_list`)}
      >
        <div class="flap-colheader" aria-hidden="true">
          ${a?M:A`<span class="flap-colheader__line"
                >${this._t(`col_line`)}</span
              >`}
          <span
            class="flap-colheader__dest"
            style=${H({maxWidth:`${d}px`})}
          >
            <span>${this._t(`col_dest`)}</span>
            ${i?A`<span class="flap-colheader__step-free"
                  >${this._t(`col_step_free`)}</span
                >`:M}
          </span>
          ${n?A`<span class="flap-colheader__platform"
                >${r}</span
              >`:M}
    ...
    `}_renderRow(e,t,n,r,i,a,o){let s=this._config,c=Number.isFinite(e.countdown)?e.countdown:null,l=c!==null&&c<=0,u=(e.line??`?`).toUpperCase(),d=u.padStart(o,` `),f=(e.towards??``).toUpperCase(),p=[u,f,c===null?this._t(`no_data`):l?this._t(`at_platform`):this._t(`countdown_minutes`,{n:String(c)}),e.timetable?this._t(`timetable_title`):``].filter(Boolean).join(` — `),m=rn(u,{},n),h=m.background===`var(--primary-color)`?{blankSpace:!0}:{tileBg:m.background,blankSpace:!0},g=this._renderFlipString(ir(e.countdown),Q(t,`cd`),{blankSpace:!0}),_=r?A`<div class="flap-cell flap-cell--platform" aria-hidden="true">
      ...
      <div class="flap-row" role="listitem" aria-label=${p}>
        ${i?M:A`<div class="flap-cell flap-cell--line" aria-hidden="true">
        ...
        <div class="flap-cell flap-cell--dest" aria-hidden="true">
          ...
          ${s.show_accessibility?e.barrier_free?this._renderPictogramTile(`mdi:wheelchair-accessibility`,this._t(`barrier_free_title`)):this._renderAccessibilityBlankTile(this._t(`not_barrier_free_title`)):M}
        </div>
        ${_}
        <div class="flap-cell flap-cell--cd" aria-hidden="true">
          ${e.timetable?this._renderPictogramTile(`mdi:calendar-clock`,this._t(`timetable_title`),`plain`):M}
          <span class="flap-cd-tiles">${g}</span>
          ${s.show_min_unit&&c!==null?A`<span class="flap-cd-unit">${this._t(`unit_min`)}</span>`:M}
        </div>
      </div>
    `}_renderFlipString(e,t,n={}){let r=(this._displayed[t]??e).split(``),i=this._justFlipped[t]??{};return A`<span class="flap-tiles" aria-label=${e}
      >${r.map((e,t)=>He(`${t}:${e}`,this._renderTile(e,i[t],t,n)))}</span
    >`}_renderTile(e,t,n,r={}){if(e===` `&&!r.blankSpace)return A`<span class="flap-space" aria-hidden="true">&nbsp;</span>`;let i=e===` `,a=i?void 0:r.tileBg,o=i?void 0:r.tileFg,s=t!==void 0,c=H({"--tile-i":String(n),...a?{"--tile-bg":a}:{},...o?{"--tile-fg":o}:{}}),l=V({"flap-tile":!0,"flap-tile--wide":r.wide===!0,"flap-tile--color":a!==void 0,"flap-tile--flipping":s,"flap-tile--blank":i}),u=e===` `?``:e;return A`<span class=${l} style=${c}>
      ...
      ${s?A`<span class="flap-tile__leaf"
            ><span class="flap-tile__glyph">${t===` `?``:t}</span></span
          >`:M}
    </span>`}_renderPictogramTile(e,t,n=`a11y`){return A`<span
      class="flap-tile flap-tile--pictogram${n===`plain`?` flap-tile--pictogram-plain`:``}"
      aria-label=${t}
    >
      ...
      <span class="flap-tile__pin flap-tile__pin--l" aria-hidden="true"></span>
      <span class="flap-tile__pin flap-tile__pin--r" aria-hidden="true"></span>
    </span>`}_renderAccessibilityBlankTile(e){return A`<span
...
}`}};Y([Ie({attribute:!1})],$.prototype,`hass`,void 0),Y([R()],$.prototype,`_config`,void 0),Y([R()],$.prototype,`_versionMismatch`,void 0),Y([R()],$.prototype,`_displayed`,void 0),Y([R()],$.prototype,`_target`,void 0),Y([R()],$.prototype,`_justFlipped`,void 0),$=Y([Ne(`wiener-linien-austria-flap-card`)],$);export{$ as WienerLinienAustriaFlapCard};